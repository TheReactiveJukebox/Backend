...
public class PublishedTest {
    ...
    private void Published(){
        ...
        Track t3 = new Track(1, "Title3", new Artist(), new Album(), "blacover", "blahash", 50, 0, d3, 120, 0.9f, "", "",0,0);
        Track t4 = new Track(2, "Title4", new Artist(), new Album(), "blacover", "blahash", 50, 0, d4, 120, 0.9f, "", "",0,0);
        Track t5 = new Track(2, "Title5", new Artist(), new Album(), "blacover", "blahash", 50, 0, new Date(), 120, 0.9f, "", "",0,0);
