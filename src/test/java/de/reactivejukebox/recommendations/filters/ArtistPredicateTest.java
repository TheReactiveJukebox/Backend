...
public class ArtistPredicateTest {
    ...
    private void TestArtistPredicateTRUE() {
        ...
        Track t1 = new Track(1, "Title1", a1, new Album(), "blacover", "blahash", 50, 0, new Date(), 120, 0.9f, "", "",0,0);
        Track t2 = new Track(2, "Title2", a2, new Album(), "blacover", "blahash", 50, 0, new Date(), 120, 0.9f, "", "",0,0);
