...
public class RadioTest {
    ...
    private void GenreTest() {
        ...
        Track t3 = new Track(1, "Title3", new Artist(), new Album(), "blacover", "blahash", 50, 0, new Date());
        Track t4 = new Track(2, "Title4", new Artist(), new Album(), "blacover", "blahash", 50, 0, new Date());
    ...
    private void PublishedTest(){
        ...
        Track t5 = new Track(2, "Title5", new Artist(), new Album(), "blacover", "blahash", 50, 0, new Date());
